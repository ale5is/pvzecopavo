...
public class AudioManager : MonoBehaviour
{
    ...
    private Dictionary<string, int> EfAudioNum =
    ...
    public void SetRainVolume(bool isStart, bool needFade)
    {
        AudioClip newClip =
            SkyManager.Instance.RainScale <= 4
                ? GameManager.Instance.AudioConf.Rain1
                : SkyManager.Instance.RainScale > 7
                    ? GameManager.Instance.AudioConf.Rain3
                    : GameManager.Instance.AudioConf.Rain2;
    ...
    {
        AudioClip newClip =
            SkyManager.Instance.HailScale > 6
                ? GameManager.Instance.AudioConf.BigHail
                : GameManager.Instance.AudioConf.SmallHail;
        ...
        AudioClip newClip)
    {
        ...
        if (isStart != currWeatherAudio.enabled)
        {
            ...
            currWeatherAudio.enabled &&
            isStart &&
            newClip != currWeatherAudio.clip)
        {
        ...
        bool needFade)
    {
        ...
        AudioClip audioClip =
            SkyManager.Instance.WindScale >= 3
                ? GameManager.Instance.AudioConf.BigWind
                : GameManager.Instance.AudioConf.SmallWind;
        ...
        if (isStart != currWindAudio.enabled)
        {
            ...
            currWindAudio.enabled &&
            isStart &&
            audioClip != currWindAudio.clip)
        {
            ...
            nextAudio.clip = audioClip;

            AudioSource oldAudio =
                currWindAudio;

            currWindAudio = nextAudio;
