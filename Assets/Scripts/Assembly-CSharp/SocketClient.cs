...
public class SocketClient : MonoBehaviour
{
    ...
    private volatile bool connectOverCalled;
    ...
    private void CloseSocket()
    {
        ...
        Thread receiveThread = ReseviceThread;
    ...
    public void JoinGame(IPAddress ip, int port, string passWord)
    {
        ...
        Socket socketForThread = newSocket;

        ReseviceThread = new Thread(() =>
        {
            try
            {
                socketForThread.Connect(endport);
                ...
                lock (socketLock)
                {
                    if (clientSocket != socketForThread)
                    {
                        return;
                    }
                }
            ...
            {
                if (Thread.CurrentThread == ReseviceThread)
                {
                    isReceiving = false;
                }
            }
        ...
        ReseviceThread.IsBackground = true;
        ReseviceThread.Start();
    }

    private void ReseviceMsg(Socket socket)
    {
        isReceiving = true;
        ...
        try
        {
            while (!isClosing)
            {
                ...
                if (flag)
                {
                    ...
                    {
                        byte[] array3 =
                            array2.Skip(0).Take(num2).ToArray();

                        byte[] array4 =
                            new byte[array.Length + array3.Length];
                    ...
                    {
                        byte[] array5 =
                            array2.Skip(0).Take(num).ToArray();

                        byte[] array6 =
                            new byte[array.Length + array5.Length];
                ...
                while (num4 > 0)
                {
                    ...
                    int remainingData = num4 - 4;

                    if (num5 > remainingData)
                    {
                        flag = true;

                        int count = remainingData;

                        num = num5 - remainingData;
        ...
        switch (b)
        {
                    ...
                    case 1:
                        {
                            ...
                            ConnectInfo connectInfo =
                                JsonUtility.FromJson<ConnectInfo>(text);
                            ...
                            else
                            {
                                UIManager.Instance.LogPanel.DisplayLog(
                                    ...
                                    () =>
                                    {
                                        ...
                                        {
                                            UIManager.Instance.JoinGame.gameObject
                                                .SetActive(true);
                                        }
                                    }
                                );
                    ...
                    case 2:
                        {
                            OnlinePlayerInfo onlinePlayerInfo =
                                JsonUtility.FromJson<OnlinePlayerInfo>(text);
                    ...
                    case 3:
                        {
                            ...
                            ReConnectInfo reConnectInfo =
                                JsonUtility.FromJson<ReConnectInfo>(text);

                            if (reConnectInfo.isWait)
                            {
                                ReConnect.Instance.OpenInit(
                                    needCnt: false
                                );
                            }
                            else
            ...
            case 1:
                ...
                switch (b2)
                {
                    case 0:
                        {
                            LoadLVBag loadLVBag =
                                JsonUtility.FromJson<LoadLVBag>(text);
                    ...
                    case 2:
                        ...
                        LVManager.Instance.ClientShowBigWave(
                            JsonUtility.FromJson<WaveComing>(text)
                        );
                    ...
                    case 3:
                        ...
                        PlayerManager.Instance.ClientUpdateSunNum(
                            JsonUtility.FromJson<SunNumBag>(text)
                        );
                    ...
                    case 4:
                        ...
                        SynItem(
                            JsonUtility.FromJson<SynItem>(text)
                        );
                    ...
                    case 5:
                        {
                            PlayerMap playerMap =
                                JsonUtility.FromJson<PlayerMap>(text);
                    ...
                    case 6:
                        {
                            SelectCard selectCard =
                                JsonUtility.FromJson<SelectCard>(text);
                    ...
                    case 7:
                        {
                            SelectPrepare selectPrepare =
                                JsonUtility.FromJson<SelectPrepare>(text);
                    ...
                    case 8:
                        {
                            GameOver gameOver =
                                JsonUtility.FromJson<GameOver>(text);
                    ...
                    case 9:
                        {
                            PvPTeamList list2 =
                                JsonUtility.FromJson<PvPTeamList>(text);
                    ...
                    case 10:
                        {
                            PvPModeSyn syn3 =
                                JsonUtility.FromJson<PvPModeSyn>(text);
                    ...
                    case 11:
                        {
                            SpectList spectList =
                                JsonUtility.FromJson<SpectList>(text);
                    ...
                    case 12:
                        {
                            AddCardBag addCardBag =
                                JsonUtility.FromJson<AddCardBag>(text);

                            SeedBank.Instance.AddCards(
                                addCardBag.CardTypes,
                                canAddSlot: true
                            );
                    ...
                    case 13:
                        {
                            FlagMeterSyn syn2 =
                                JsonUtility.FromJson<FlagMeterSyn>(text);
                    ...
                    case 14:
                        {
                            TimetableSyn syn =
                                JsonUtility.FromJson<TimetableSyn>(text);
                ...
                switch (b2)
                {
                    case 0:
                        {
                            PlantSpawn plantSpawn =
                                JsonUtility.FromJson<PlantSpawn>(text);
                            ...
                            if (
                                ...
                                !PvPSelector.Instance.IsSameTeam(
                                    plantSpawn.PlacePlayer
                                )
                            )
                            {
                                plantSpawn.GridPos =
                                    new Vector2(
                                        0f - plantSpawn.GridPos.x,
                    ...
                    case 1:
                        ...
                        SkyManager.Instance.ClientSpawnSun(
                            JsonUtility.FromJson<SunSpawn>(text)
                        );
                    ...
                    case 2:
                        ...
                        SkyManager.Instance.OnlineCollectSun(
                            JsonUtility.FromJson<ClickedSun>(text)
                        );
                    ...
                    case 3:
                        {
                            PlantPreview apply2 =
                                JsonUtility.FromJson<PlantPreview>(text);
                    ...
                    case 4:
                        {
                            UpdateCardCD updateCardCD =
                                JsonUtility.FromJson<UpdateCardCD>(text);
                    ...
                    case 5:
                        {
                            ShovelPreview shovelPreview =
                                JsonUtility.FromJson<ShovelPreview>(text);
                    ...
                    case 6:
                        {
                            ToolApply toolApply =
                                JsonUtility.FromJson<ToolApply>(text);
            ...
            case 3:
                ...
                switch (b2)
                {
                    case 0:
                        {
                            ZombieSpawn spawnInfo =
                                JsonUtility.FromJson<ZombieSpawn>(text);
                    ...
                    case 1:
                        {
                            GraveStoneSpawn graveStoneSpawn =
                                JsonUtility.FromJson<GraveStoneSpawn>(text);

                            MapManager.Instance
                                .GetGridByWorldPos(
                                    graveStoneSpawn.MapPos
                                )
                                .ClientSynGrave(
                                    graveStoneSpawn.Type,
                                    graveStoneSpawn.isHave
                                );
                    ...
                    case 2:
                        {
                            PuddleSpawn puddleSpawn =
                                JsonUtility.FromJson<PuddleSpawn>(text);
                    ...
                    case 3:
                        {
                            LightingSpawn lightingSpawn =
                                JsonUtility.FromJson<LightingSpawn>(text);
                    ...
                    case 4:
                        {
                            SynMap synMap =
                                JsonUtility.FromJson<SynMap>(text);

                            MapManager.Instance
                                .GetCurrMap(synMap.mapPos)
                                .SynMap(synMap);
                    ...
                    case 5:
                        {
                            ZombiePreview apply =
                                JsonUtility.FromJson<ZombiePreview>(text);
                    ...
                    case 6:
                        {
                            PortalSpawn spawn3 =
                                JsonUtility.FromJson<PortalSpawn>(text);
                    ...
                    case 7:
                        {
                            SynGrid synGrid =
                                JsonUtility.FromJson<SynGrid>(text);
                    ...
                    case 8:
                        {
                            SynBooty synBooty =
                                JsonUtility.FromJson<SynBooty>(text);
                    ...
                    case 9:
                        {
                            VaseSpawn vaseSpawn =
                                JsonUtility.FromJson<VaseSpawn>(text);
                    ...
                    case 10:
                        {
                            CardSpawn cardSpawn =
                                JsonUtility.FromJson<CardSpawn>(text);
                    ...
                    case 11:
                        {
                            MeltSpawn spawn2 =
                                JsonUtility.FromJson<MeltSpawn>(text);
                    ...
                    case 12:
                        {
                            FallHailSpawn spawn =
                                JsonUtility.FromJson<FallHailSpawn>(text);
            ...
            case 4:
                ...
                switch (b2)
                {
                    ...
                    case 3:
                        {
                            CommandBag commandBag =
                                JsonUtility.FromJson<CommandBag>(text);
                    ...
                    case 4:
                        {
                            WeatherChange bag =
                                JsonUtility.FromJson<WeatherChange>(text);
                    ...
                    case 5:
                        {
                            TimeCmd timeCmd =
                                JsonUtility.FromJson<TimeCmd>(text);
                    ...
                    case 6:
                        {
                            GetAcvment getAcvment =
                                JsonUtility.FromJson<GetAcvment>(text);
    ...
    private void SendMsg(
        ...
        Socket socket = null)
    {
        Socket socketToUse = socket;

        if (socketToUse == null)
        {
            lock (socketLock)
            {
                socketToUse = clientSocket;
            }
        }
        ...
        try
        {
            ...
            list.InsertRange(
                0,
                BitConverter.GetBytes(list.Count)
            );
    ...
    private IEnumerator SendHeartbeat()
    {
        ...
        while (GameManager.Instance.isOnline)
        {
            ...
            if (
                Time.realtimeSinceStartup - startT >
                0.5f
            )
            {
                SendMsg(
    ...
    private IEnumerator WaitLog()
    {
        ...
        while (
            Time.realtimeSinceStartup - startT <= 3f &&
            !GameManager.Instance.isOnline &&
            WaitConnect != null
        )
        {
    ...
    public void SynItem(SynItem syn)
    {
        ...
        {
            List<ZombieBase> list =
                new List<ZombieBase>(
                    ZombieManager.Instance
                        .GetAllZombies()
                );

            List<ZombieBase> allHypZombies =
                ZombieManager.Instance
                    .GetAllHypZombies();
        ...
        {
            LvItemManager.Instance.SynVase(
                syn
            );
        }
